...
uint8 scc8660_init (void)
{
    ...
    set_camera_type(CAMERA_COLOR, scc8660_vsync_handler, scc8660_dma_handler, scc8660_uart_handler);
    camera_fifo_init();
...
//    }
    ...
    do
    {
        if(scc8660_set_config(scc8660_set_confing_buffer))
        {
            ...
            uart_rx_interrupt(SCC8660_COF_UART, 0);
            set_camera_type(NO_CAMERE, NULL, NULL, NULL);
            return_state = 1;
            break;
        }
