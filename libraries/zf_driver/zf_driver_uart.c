...
static  IRQn_Type   uart_irq[UART_NUM]              = {UART1_IRQn, UART2_IRQn, UART3_IRQn, UART4_IRQn, UART5_IRQn, UART6_IRQn, UART7_IRQn};
static  uint8       uart_interrupt_state[UART_NUM]  = {0, 0, 0, 0, 0, 0, 0};
