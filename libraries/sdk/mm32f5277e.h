...
typedef struct {
    ...
    __IO uint32_t Reserved9[36];                                                  ///< Reserved
	...
	__IO uint32_t Reserved10[14];                                                  ///< Reserved
	...
	__IO uint32_t Reserved11[5];                                                  ///< Reserved
	...
	__IO uint32_t Reserved15[93];                                                 ///< Reserved
	...
	__IO uint32_t Reserved18[542];                                                ///< Reserved
	...
	__IO uint32_t Reserved19[8];                                                  ///< Reserved
